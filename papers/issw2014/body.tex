...
Utilizing the simulation settings similar to the benchmark problem a simulation was performed on a $\mu$-CT scanned cross-section of snow measuring \unit[5]{mm} square. This sample was subjected to a temperature gradient of \unitfrac[400]{K}{m} over four hours. Fig. \ref{fig:snow2d} includes the snow image overlaid with the areas that observed sublimation (hot colors) and deposition (cold colors).

\setlength{\unitlength}{1in}
\begin{figure*}[ht!]\label{fig:snow2d}
  \begin{subfigure}[c]{0.453\textwidth}
    \includegraphics[width=\textwidth]{figures/snow2d_raw.png}
    \put(-2.9445 ,0){\includegraphics[width=\linewidth]{figures/diff_overlay.png}}
    \caption{Phase-change}
    \label{fig:snow2d:a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[c]{0.547\textwidth}
    \includegraphics[width=\textwidth]{figures/snow2d_temp.pdf}
    \caption{Grains before and after}
    \label{fig:snow2d:b}
  \end{subfigure}
\end{figure*}
...
Note: simple kinetics, boundary conditions (no flux) not conducive to large changes
